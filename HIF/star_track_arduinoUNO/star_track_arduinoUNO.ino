...
// void recvdata() {
//   Serial.println("Enter the coordinates (format: x,y):");
...
//   if (commaIndex != -1) { // Check if the comma is found in the input
//     String xStr = input.substring(0, commaIndex); // Extract the x-coordinate substring
//     String yStr = input.substring(commaIndex + 1); // Extract the y-coordinate substring

//     xStr.trim(); // Remove whitespace
//     yStr.trim(); // Remove whitespace

//     val = 90-xStr.toDouble(); // Convert x-coordinate string to double
//     val2 = yStr.toDouble(); // Convert y-coordinate string to double
//     temp=val2;
...
//     // Store the values in global variables or use them as needed
//     // val and val2 now hold the double values of the coordinates
//   } else {
//     Serial.println("Invalid input format. Please enter coordinates in the format: x,y");
//   }
// }
